<%@page import="com.inventory.InventoryDetails"%>
...
<th style="color:#c7c7c7;height:50px;font-size:1.2em;">Id</th>
<th style="color:#c7c7c7;height:50px;font-size:1.2em;">In stock</th>
<th style="color:#c7c7c7;height:50px;font-size:1.2em;">Req</th>
<th style="color:#c7c7c7;height:50px;font-size:1.2em;">Buffer</th>
<th style="color:#c7c7c7;height:50px;font-size:1.2em;">Price</th>
<th style="color:#c7c7c7;height:50px;font-size:1.2em;">Pending</th>
...
list = (ArrayList<InventoryDetails>)request.getAttribute("mybooklist3");
Iterator<InventoryDetails> it=list.iterator();
while(it.hasNext())
{InventoryDetails book=it.next(); %>

<tr>
<td style="font-size:1.2em;text-align:center;"><%=book.getName()%> </td>
<td style="font-size:1.2em;text-align:center;"><%=book.getId()%> </td>
<td style="font-size:1.2em;text-align:center;"><%=book.getStock()%></td>
<td style="font-size:1.2em;text-align:center;"><%=book.getReq()%> </td>
<td style="font-size:1.2em;text-align:center;"><%=book.getBuffer()%> </td>
<td style="font-size:1.2em;text-align:center;"><%=book.getPrice()%></td>
<td style="font-size:1.2em;text-align:center;"><%=book.getPending()%> </td>
<td style="font-size:1.2em;text-align:center;"><%=book.getRating()%> </td>
<td> <a  type="button" style="background-color:#e6e6e6;color:#d0d0d0;border:none;width:7em;padding:8px;border-radius:17px;"  href="#">Manage</a> </td>
